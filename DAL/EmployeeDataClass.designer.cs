...
namespace DAL
{
    ...
    partial void InsertEMPOLYEE(EMPOLYEE instance);
    partial void UpdateEMPOLYEE(EMPOLYEE instance);
    partial void DeleteEMPOLYEE(EMPOLYEE instance);
    ...
    partial void DeleteTASKSTATE(TASKSTATE instance);
		...
		public System.Data.Linq.Table<EMPOLYEE> EMPOLYEEs
		{
			get
			{
				return this.GetTable<EMPOLYEE>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.EMPOLYEE")]
	public partial class EMPOLYEE : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnTaskStateChanged();
        ...
        public static int OnEmployee { get; set; }
